            ...
            <CardContent>
                ...
                <div className="flex flex-col gap-2 mt-2">
                    ...
                    <div className="flex gap-2">
                        <a href={github} target="_blank" className="text-[10px] tracking-wider bg-zinc-900 hover:bg-zinc-800 px-2 py-1 rounded-lg uppercase font-medium transition-colors duration-600">
                            Github
                            </a>
