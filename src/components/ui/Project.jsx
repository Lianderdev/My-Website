            ...
            <CardContent>
                ...
                <div className="flex flex-col gap-2 mt-2">
                    ...
                    <div className="flex gap-2">
                        <a href={github} target="_blank" className="text-xs tracking-wider bg-zinc-900 hover:bg-zinc-800 px-3 py-2 rounded-lg uppercase font-medium transition-colors duration-600">Github</a>
                        <a href={link} target="_blank" className="text-xs tracking-wider bg-zinc-900 hover:bg-zinc-800 px-3 py-2 rounded-lg uppercase font-medium transition-colors duration-600">Deploy</a>
                    </div>
                </div>
            </CardContent>
        </Card>
